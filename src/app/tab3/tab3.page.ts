...
export class Tab3Page {
    ...
    constructor(private router: Router,
        ...
        this.userService.getUserInfo().subscribe(res => {
            ...
            this.authority =  res.result['authorities'][0]['authority']
    ...
    ngOnInit() {
        ...
        console.log('url' + this.userService.user.photoUrl);
                ...
                handler: () => {
                    this.imageService.getImageFromLibrary().then(
                        (imageData) => {
                            ...
                            const storageRef = firebase.storage().ref('profile/photo/' + this.userName + '.jpg');
                            this.presentLoading();
